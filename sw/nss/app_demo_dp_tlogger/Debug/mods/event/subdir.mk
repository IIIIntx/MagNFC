...
mods/event/event.o: D:/OneDrive\ -\ HKUST\ (Guangzhou)/SchoolTasks/SCuMRobot/magNFC/release_mra2_12_6_nhs3152/sw/nss/mods/event/event.c mods/event/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-mods-2f-event

clean-mods-2f-event:
	-$(RM) ./mods/event/event.d ./mods/event/event.o

.PHONY: clean-mods-2f-event
