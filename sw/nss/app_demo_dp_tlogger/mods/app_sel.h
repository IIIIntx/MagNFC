...
#include <stdint.h>
    ...
    #error Under MCUXPresso: Project > Properties > C/C++ Build > Settings > Tool Settings > MCU C Compiler > Preprocessor
    #error Add a define similar to "SW_MAJOR_VERSION=1"
    #error Add this define to all build configurations.
#endif
// "SW_MAJOR_VERSION=$(shell busybox date +%y%V)" to have it contain year and weeknumber: YYWW
// "SW_MAJOR_VERSION=$(shell busybox date +%s) to have it contain unix epoch time in seconds.

#if !defined(SW_MINOR_VERSION)
    #error SW_MINOR_VERSION not defined. Define SW_MINOR_VERSION in your Project settings.
    #error Under MCUXPresso: Project > Properties > C/C++ Build > Settings > Tool Settings > MCU C Compiler > Preprocessor
    #error Add a define similar to "SW_MINOR_VERSION=1"
    #error Add this define to all build configurations.
#endif
