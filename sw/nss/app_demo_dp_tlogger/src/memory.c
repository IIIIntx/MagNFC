...
/* ------------------------------------------------------------------------- */
    ...
    #error Add for example the define "APP_BUILD_TIMESTAMP=$(shell busybox date +%s)" (including quotes)
    #error Add this define to all build configurations.
#endif
/**
 * The define @c APP_BUILD_TIMESTAMP is re-calculated for each C file being compiled, and MCUXPresso caches
