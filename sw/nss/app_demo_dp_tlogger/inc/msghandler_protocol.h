...
/**
 * A value used to indicate a measurement was due while an NFC field was present. The measurement did not take place
 * and this value was stored instead.
 */
 ...
 *  @n@n
 *
 * -# If no temperature values are available, the response consists of just the structure
